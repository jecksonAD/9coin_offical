...
class ProductDetailsPageNotification extends StatefulWidget {
  final int id;
  final String name;
  final String image;
  final int totalpicture;
  final int randomnumber;
  const ProductDetailsPageNotification(
      this.id, this.name, this.image, this.totalpicture, this.randomnumber,
      {super.key});

  @override
  State<ProductDetailsPageNotification> createState() =>
      _ProductDetailsPageState();
}

class _ProductDetailsPageState extends State<ProductDetailsPageNotification>
